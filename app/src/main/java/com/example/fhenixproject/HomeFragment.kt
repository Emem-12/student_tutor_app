...
private  lateinit var listOfInstitution: MutableList<Institution>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val institution1= Institution(R.drawable.institution_icon1,"Concordia University","Computer Science and Technology","hiuvbv hdsijc buhudhiuh uhdfajkjjoihf hhiujfjfdnhk hfjhui")
        val institution2= Institution(R.drawable.tutor2_2,"AKSU","Arts","hiuvbv hdsijc buhudhiuh uhdfajkjjoihf hhiujfjfdnhk hfjhui")
        val institution3= Institution(R.drawable.institute3,"Idahosa University","Engineering","hiuvbv hdsijc buhudhiuh uhdfajkjjoihf hhiujfjfdnhk hfjhui")
       /* val institution4= Institution(R.drawable.image,"AAU","Bio Science","hiuvbv hdsijc buhudhiuh uhdfajkjjoihf hhiujfjfdnhk hfjhui")
        val institution5= Institution(R.drawable.image,"College of Sciences","Sciences","hiuvbv hdsijc buhudhiuh uhdfajkjjoihf hhiujfjfdnhk hfjhui")
        val institution6= Institution(R.drawable.image,"UniBen","Science and Art","hiuvbv hdsijc buhudhiuh uhdfajkjjoihf hhiujfjfdnhk hfjhui")
        */ listOfInstitution=mutableListOf(institution3,institution2,institution1)
        ...
        binding.instiRecycler.layoutManager = LinearLayoutManager(requireContext(),
        ...
        binding.popularTeachersRecycler.layoutManager= LinearLayoutManager(requireContext(),
